...
// Step 4: Let's use the OnValue method to pull in our data from firebase - Don't forget to import it at the top of the page!
 ...
 // function that toggles the empty class of showSearch to create the transition, this statement also sets the search icon to display and the close icon to none so that the close icon doesnt show 
 ...
 if (searchBar.classList.contains("showSearch")) {
   ...
   // else statement stops the search icon from showing and displays the close icon 
 } else {
